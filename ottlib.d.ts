declare module '@otter-co/ottlib/lib/utils' {
...
declare module '@otter-co/ottlib/lib/dataman' {
	export class DataManager {
	    dataCon: DataConnection;
	    dataGetters: object;
	    constructor(dataCon: DataConnection);
	    addDataGetter(Getter: new (DataConnection) => {
	        serviceName: string;
	    }): void;
	}
	...
	export class DataGetter {
	    ...
	    serviceName: string;
	    constructor(dataCon: DataConnection);
	    add(data: any): Promise<DataResponse>;
	    get(id: any): Promise<DataResponse>;
	    set(id: any, data: any): Promise<DataResponse>;
	    rid(id: any): Promise<DataResponse>;
	}
...
declare module '@otter-co/ottlib/lib/ottstify' {
	import * as restify from 'restify';
	import DataManager from '@otter-co/ottlib/lib/dataman';
	export class RestServer {
	    ...
	    private server;
	    private urls;
	    constructor(cfg: any, dm: DataManager);
	    start(): Promise<object>;
	    setup(): void;
	    addURL(urlC: typeof RestURL): Set<typeof RestURL>;
	}
	...
	export class RestURL {
	    ...
	    static url: string;
	    static type: string;
	    constructor(parent: RestServer, dm: DataManager);
	    onLoad(rest: RestObj, data?: any, cookies?: any): void;
	    end(rest: RestObj, data: any): void;
	}
...
declare module '@otter-co/ottlib/lib/logger' {
	export class Logger {
	    private logDir;
	    private logInConsole;
	    private logTypes;
	    logs: object;
	    constructor(logDir: string, logTypes: typeof LogType[], logInConsole?: boolean);
	    start(): void;
	    log(str: string, serv: string): void;
	}
	export default Logger;
	export class LogType {
	    static logType: string;
	    private logger;
...
declare module '@otter-co/ottlib/lib/config' {
	export class ConfigHandler {
	    config: object;
	    private liveReload;
	    private cfgPath;
	    constructor(cfgPath: string, defCfg?: {}, liveReload?: boolean);
	    start(): Promise<any>;
...
declare module '@otter-co/ottlib/extras/dataman_extra' {
	import { DataConnection } from '@otter-co/ottlib/index';
...
declare module '@otter-co/ottlib/index' {
	 var _default: {
	    name: string;
	    org: string;
	};
	export default _default;
	export * from '@otter-co/ottlib/lib/ottstify';
	export * from '@otter-co/ottlib/lib/logger';
	export * from '@otter-co/ottlib/lib/config';
	export * from '@otter-co/ottlib/lib/dataman';
	export * from '@otter-co/ottlib/lib/utils';
	import * as dman_extras from '@otter-co/ottlib/extras/dataman_extra';
	export let dataman_extras: typeof dman_extras;

}
declare module '@otter-co/ottlib/lib/services' {
